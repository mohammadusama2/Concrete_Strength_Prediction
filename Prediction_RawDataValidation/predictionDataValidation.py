...
class Prediction_Data_Validation:
    ...
    """
    This class shall be used for handling all the validation on Raw Prediction Data.
    """
    ...
    def manualRegexCreation(self):
        ...
        Description: This mehtod contains a manually defined regex based on file name given in schema.
                    This regex will be used to validate the file name of the prediction data.
    ...
    def createDirectoryforGoodBadRawData(self):
        ...
        """
        Description: This creates directory to store the Good Data and Bad Data after validating the prediction data.
        Output: None
        OnFailure: OSError
