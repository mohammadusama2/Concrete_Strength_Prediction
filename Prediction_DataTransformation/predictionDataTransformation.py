...
class dataTransform:
    ...
    """
    This class shall be used for transformaing the Good Raw Prediction Data before loading it in database
    """
    ...
    def renameColumns(self):
        ...
        log_file = open("Prediction_Logs/renameColumns.txt", 'a+')
